...
function (_super) {
  ...
  Boot.prototype.preload = function () {
    ...
    this.load.spritesheet("animation", "assets/images/spritesheet_1.png", {
      frameWidth: 1024,
      frameHeight: 1024
    });
    this.load.spritesheet("animation1", "assets/images/spritesheet_2.png", {
      frameWidth: 1024,
      frameHeight: 1024
    });
  ...
  Boot.prototype.create = function () {
    ...
    this.music = this.sound.add('colonna', {
      loop: true
    });
    this.music.play();
    ...
    this.anims.create({
      key: "playAnimation1",
      frames: this.anims.generateFrameNumbers("animation1", {
        start: 0,
        end: 6
      }),
      frameRate: 2,
        ...
        _this.sprite.once("animationcomplete", function () {
          ...
          _this.bg.once("animationcomplete", function () {
            ...
            _this.tweens.add({
              ...
              duration: 4000,
              ease: 'Sine.easeInOut',
              onUpdate: function onUpdate(tween) {// Spostati indietro regolando la profondità (depth)
